...
module.exports = [
  ...
  {
    shortName: 'dom-node-bun',
    entryPoints: [
      'react-server-dom-bun/src/client/react-flight-dom-client.node',
      'react-server-dom-bun/src/server/react-flight-dom-server.node',
    ],
    paths: [
      'react-dom',
      'react-dom-bindings',
      ...
      'react-server-dom-bun/client.node',
      'react-server-dom-bun/server',
      'react-server-dom-bun/server.node',
      'react-server-dom-bun/static',
      'react-server-dom-bun/static.node',
      'react-server-dom-bun/src/client/ReactFlightDOMClientEdge.js', // react-server-dom-bun/client.node
      'react-server-dom-bun/src/client/ReactFlightDOMClientNode.js', // react-server-dom-bun/client.node
      'react-server-dom-bun/src/client/ReactFlightClientConfigBundlerBun.js',
      'react-server-dom-bun/src/client/ReactFlightClientConfigBundlerBunServer.js',
      'react-server-dom-bun/src/client/react-flight-dom-client.node',
      'react-server-dom-bun/src/server/react-flight-dom-server.node',
      'react-server-dom-bun/src/server/ReactFlightDOMServerNode.js', // react-server-dom-bun/src/server/react-flight-dom-server.node
      'react-devtools',
      'react-devtools-core',
      'react-devtools-shell',
      'react-devtools-shared',
  ...
  },
  {
    ...
    paths: [
      ...
      'react-server-dom-bun/client.browser',
      'react-server-dom-bun/server.browser',
      'react-server-dom-bun/static.browser',
      'react-server-dom-bun/src/client/ReactFlightDOMClientBrowser.js', // react-server-dom-bun/client.browser
      'react-server-dom-bun/src/client/ReactFlightClientConfigBundlerBun.js',
      'react-server-dom-bun/src/client/ReactFlightClientConfigBundlerBunBrowser.js',
      'react-server-dom-bun/src/client/react-flight-dom-client.browser',
      'react-server-dom-bun/src/server/react-flight-dom-server.browser',
      'react-server-dom-bun/src/server/ReactFlightDOMServerBrowser.js', // react-server-dom-bun/src/server/react-flight-dom-server.browser
      'react-devtools',
      'react-devtools-core',
      'react-devtools-shell',
      'react-devtools-shared',
  ...
  },
  {
    ...
    paths: [
      ...
      'react-server-dom-bun/src/client/ReactFlightDOMClientEdge.js', // react-server-dom-bun/client.edge
      'react-server-dom-bun/src/client/ReactFlightClientConfigBundlerBun.js',
      'react-server-dom-bun/src/client/ReactFlightClientConfigBundlerBunServer.js',
      'react-server-dom-bun/src/client/react-flight-dom-client.edge',
      'react-server-dom-bun/src/server/react-flight-dom-server.edge',
      'react-server-dom-bun/src/server/ReactFlightDOMServerEdge.js', // react-server-dom-bun/src/server/react-flight-dom-server.edge
      'react-devtools',
      'react-devtools-core',
      'react-devtools-shell',
      'react-devtools-shared',
